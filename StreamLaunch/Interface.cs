...
namespace StreamLaunch
{
    ...
    {
        // original notes
        private Pitch[,] notesOld = new Pitch[8, 8] {
        ...
        // notes that work with my gen 1 Novation Launchpad
        ...
        private Pitch[] rightLEDnotesOld = new Pitch[] {
        ...
        private Pitch[] topLEDNotesOld = new Pitch[] {
